module.exports = {
    ...
    read_where: `SELECT id_reponseOuverte FROM choix_reponses WHERE id_participant=?`,
    read_where_intit: `SELECT intitule_rep FROM choix_reponses WHERE id_participant=?`,
